...
// ContentProvider represents a content provider component (normalized)
type ContentProvider struct {
	...
	Authorities         string `json:"authorities" gorm:"type:json;column:authorities"`
	GrantUriPermissions bool   `json:"grantUriPermissions" gorm:"column:grant_uri_permissions;default:false"`

	// Relationship
	Secret Secret `json:"-" gorm:"foreignKey:SecretID"`
}

// TableName specifies the table name for ContentProvider
