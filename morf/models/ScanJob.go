...
// ToJSON converts ScanJob to JSON string
func (j *ScanJob) ToJSON() (string, error) {
...
// FromJSON creates ScanJob from JSON string
func (j *ScanJob) FromJSON(data string) error {
