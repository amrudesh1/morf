...
// SetDBPoolConnections sets database pool connection count by state
func SetDBPoolConnections(state string, count float64) {
	DBPoolConnections.WithLabelValues(state).Set(count)
}
